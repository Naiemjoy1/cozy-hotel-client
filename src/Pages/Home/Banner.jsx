  ...
  return (
    <div>
      ...
      >
        ...
        <div className=" flex justify-center items-center text-center text-white lg:container lg:mx-auto gap-10 py-28">
          <div className="lg:w-1/2 space-y-5">
            <p className=" font-roboto font-semibold">BEST PLACE FOR RELAX</p>
            <p className=" font-marcellus font-normal text-2xl lg:text-5xl">
